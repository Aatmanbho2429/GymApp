...
{
    /// <inheritdoc />
    public partial class add_Pt_toUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkoutCard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MeasurementCard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PackageId = table.Column<int>(type: "int", nullable: true),
                    AmountPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Pt = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsPt = table.Column<bool>(type: "bit", nullable: true),
